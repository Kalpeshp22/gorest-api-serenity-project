...
public class UserCURDTest extends TestBase {
    static String name = "Diya Patel" + TestUtils.getRandomValue();
    static String email = TestUtils.getRandomValue() + "Diapatel@gmail.com";
    ...
    public void test003() {
        ...
        gender="female";
        email="mishra_prathamesh@wisozk.net";
        status="active";
        userId =  3706;
        UserPojo userPojo = new UserPojo();
        userPojo.setName(name);
    ...
    @Title("Delete the user and verify if the user is deleted! for ID=3706")
    @Test
    public void test004() {
        userId =  3706;
